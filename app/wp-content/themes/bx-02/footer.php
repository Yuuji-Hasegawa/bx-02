...
<footer class="c-hero">
    <div class="o-cover o-cover:footerInner">
        <div class="o-stack o-stack:footer-logo">
            <a href="<?php echo home_url();?>" class="c-footer-logo">
                <span class="c-hero__icon c-hero__icon:footer">
                ...
                <span class="c-hero__logo"> BLUE B NOSE </span>
            </a>
            <div class="o-cluster o-cluster:bottomSns">
                <a href="<?php echo get_vars('sns', 'fb');?>"
                    class="c-link c-link:bottomSns" target="_blank" rel="noopener">
        ...
        <div class="c-footer-address">
            ...
            営業時間 : <?php echo get_vars('company', 'open');?>〜<?php echo get_vars('company', 'close');?>（L.0
            <?php echo get_vars('store', 'l.o');?>）<br />
            定休日 : <?php echo get_vars('company', 'dayoff');?><br />
            ご予約 :
            <a href="tel:<?php echo get_vars('company', 'tel');?>"
                class="o-has-icon o-has-icon:footerphone">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                    <path
                ...
                <span class="c-phone-number c-phone-number:footer"><?php echo get_vars('company', 'tel');?></span>
            </a>
        </div>
        ...
        <span class="c-copyright"><?php echo get_vars('site', 'copyright');?></span>
    </div>
    ...
    <span class="c-hero__overlay"></span>
</footer>
<?php wp_footer();?>
</body>
